...
@section('content')
    ...
    <form method="post" name="frm" id="frm">
        ...
        <div class="form-group">
            ...
            <label for="totalTax">Total Tax Allowance</label>
        ...
        <div class="form-group mb-3">
            ...
            <button class="btn btn-outline-success mr-2" type="button" data-toggle="tooltip" title="Add a payment line." id="add_payment">Add Payment</button>

            <button class="btn btn-outline-danger mr-2" type="button" data-toggle="tooltip" title="Remove a new payment line." id="remove_payment" disabled>Remove Payment</button>

            <button class="btn btn-outline-primary" type="submit" data-toggle="tooltip" title="Reload the page.">Reset</button>
